...
namespace Sextant.NativeAPI
{
    public static class Keyboard
    {
        ...
        public enum HotkeyKey : uint
        {
            ...
            VK_F23                 = 0x86,
            VK_F24                 = 0x87,
            //VK_UNASSIGNED        = 0x88-8F,
            VK_NUMLOCK             = 0x90,
            VK_SCROLL              = 0x91,
            //VK_OEM_SPECIFIC      = 0x92-96,
            //VK_UNASSIGNED        = 0x97-9F,
            VK_LSHIFT              = 0xA0,
            VK_RSHIFT              = 0xA1,
            VK_LCONTROL            = 0xA2,
            VK_RCONTROL            = 0xA3,
            ...
            VK_OEM_102             = 0xE2,
            //VK_OEM_SPECIFIC      = 0xE3-E4,
            VK_PROCESSKEY          = 0xE5,
            //VK_OEM_SPECIFIC      = 0xE6,
            VK_PACKET              = 0xE7,
            VK_UNASSIGNED          = 0xE8,
            //VK_OEM_SPECIFIC      = 0xE9-F5,
            VK_ATTN                = 0xF6,
            VK_CRSEL               = 0xF7,
            VK_EXSEL               = 0xF8,
            VK_EREOF               = 0xF9,
